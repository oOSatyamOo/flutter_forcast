...
abstract class AppLocalizations {
  ...
  /// No description provided for @deepLinkMessage.
  ///
  /// In en, this message translates to:
  /// **'You were linked to \"{city}\".\nSearch for it on the home screen to view the full forecast.'**
  String deepLinkMessage(String city);

  /// No description provided for @deepLinkMessageEmpty.
  ///
  /// In en, this message translates to:
...
class _AppLocalizationsDelegate
  ...
  bool isSupported(Locale locale) =>
      <String>['en', 'hi', 'ja', 'ru', 'ta'].contains(locale.languageCode);
